...
public interface Spam {
   ...
   *     com.fissy.dialer.logging.ReportingLocation}.
   * @param contactLookupResultType The result of the contact lookup for this phone number. Must be
   *     one of {@link com.fissy.dialer.logging.ContactLookupResult}.
   */
   ...
   *     indicates its source. Must be one of {@link com.fissy.dialer.logging.ContactSource}.
   */
