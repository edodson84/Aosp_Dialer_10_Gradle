...
public  final class PhoneLookupInfo extends
  ...
  bitField0_ |= 0x00000040;
      ...
      protected final Object dynamicMethod(
        ...
        switch (method) {
          ...
          case GET_PARSER: {
            if (PARSER == null) {    synchronized (com.fissy.dialer.phonelookup.PhoneLookupInfo.Cp2Info.Cp2ContactInfo.class) {
                if (PARSER == null) {
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.fissy.dialer.phonelookup.PhoneLookupInfo.Cp2Info.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class SpamInfo extends
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.fissy.dialer.phonelookup.PhoneLookupInfo.SpamInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000040;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.fissy.dialer.phonelookup.PhoneLookupInfo.PeopleApiInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class SystemBlockedNumberInfo extends
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.fissy.dialer.phonelookup.PhoneLookupInfo.SystemBlockedNumberInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000001;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.fissy.dialer.phonelookup.PhoneLookupInfo.CnapInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000004;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.fissy.dialer.phonelookup.PhoneLookupInfo.CequintInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class EmergencyInfo extends
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.fissy.dialer.phonelookup.PhoneLookupInfo.EmergencyInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000004;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (com.fissy.dialer.phonelookup.PhoneLookupInfo.MigratedInfo.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (com.fissy.dialer.phonelookup.PhoneLookupInfo.class) {
            if (PARSER == null) {
              PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
            }
          }
