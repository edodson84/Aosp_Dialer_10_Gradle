...
public interface LoggingBindings {
   ...
   * @see com.fissy.dialer.logging.InteractionEvent
   */
   ...
   * @see com.fissy.dialer.logging.ScreenEvent
   */
  void logScreenView(com.fissy.dialer.logging.ScreenEvent.Type screenEvent, Activity activity);
