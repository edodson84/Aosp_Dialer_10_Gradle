...
import com.fissy.dialer.enrichedcall.EnrichedCallManager.CapabilitiesListener;
import com.fissy.dialer.enrichedcall.EnrichedCallManager.Filter;
...
import com.fissy.dialer.logging.ContactLookupResult.Type;
...
import com.fissy.dialer.rtt.RttTranscript;
...
public class DialerCall implements VideoTechListener, StateChangedListener, CapabilitiesListener {
    ...
    private com.fissy.dialer.logging.VideoTech.Type selectedAvailableVideoTechType =
            com.fissy.dialer.logging.VideoTech.Type.NONE;
    ...
    public VideoTech getVideoTech() {
        if (videoTech == null) {
            ...
            if (selectedAvailableVideoTechType == com.fissy.dialer.logging.VideoTech.Type.NONE) {
    ...
    public com.fissy.dialer.logging.VideoTech.Type getSelectedAvailableVideoTechType() {
